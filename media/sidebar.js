...
const ICONS = {
  ...
  task: `<svg width="16" height="16" viewBox="0 0 24 24" fill="#71717a"><rect x="3" y="3" width="18" height="18" rx="4" /><circle cx="8" cy="9" r="1.5" fill="white" /><path d="M11 9h5" stroke="white" stroke-width="2" stroke-linecap="round" /><circle cx="8" cy="15" r="1.5" fill="white" /><path d="M11 15h5" stroke="white" stroke-width="2" stroke-linecap="round" /></svg>`,
